...
class SellingController extends Controller
{
    ...
    public function update(Request $request, Selling $selling)
    {
        ...
        $selling->code_trans = $request->code_trans;
        ...
        return redirect()->route('sellings.index')->withSuccess('Great! You have sucessfully Update '.$selling->product_name);
    }
    ...
    public function import() 
    {
        ...
        return redirect()->route('sellings.index')->withSuccess('Great! You have successfully imported');
    }
}