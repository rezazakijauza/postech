...
use App\Imports\PurchasingImport;
...
class PurchasingController extends Controller
{
    ...
    {
        return Excel::download(new PurchasingExport, 'purchasing.xlsx');
    }

    public function import() 
    {
        Excel::import(new PurchasingImport, request()->file('file'));
        return redirect()->route('purchasing.index')->withSuccess('Great! You have successfully imported');
    }
}